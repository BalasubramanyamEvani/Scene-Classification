...
def get_opts():
    ...
    parser.add_argument(
        "--feat-dir", type=str, default="../feat", help="feature folder"
    )
    ...
    parser.add_argument("--K", type=int, default=100, help="# of words")
    parser.add_argument(
        "--alpha",
        type=int,
        default=100,
    ...
    parser.add_argument(
        "--L", type=int, default=3, help="# of layers in spatial pyramid matching (SPM)"
    )
